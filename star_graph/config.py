...
CONFIG_SCHEMA: dict[str, dict[str, tuple]] = {
    ...
    "sleep": {
        ...
        "rebuild_fuse_threshold":       (float, False, 0.0, 1.0, None),
        "rebuild_min_cluster":          (int, False, 2, 50, None),
        "rewire_drop_threshold":        (float, False, 0.0, 1.0, None),
        "rewire_strengthen_min_coact":  (int, False, 1, 100, None),
        "rewire_transitive_min_weight": (float, False, 0.0, 1.0, None),
        "rewire_transitive_decay":      (float, False, 0.0, 1.0, None),
        "abstractive_min_group":        (int, False, 2, 100, None),
        "abstractive_decay_factor":     (float, False, 0.0, 1.0, None),
        "dynamic_cluster_coact":        (int, False, 1, 100, None),
    },
    "graph": {
